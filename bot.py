...
@client.event
async def on_ready():
    await client.get_channel(870028201924108310).send(random.choice(GREETINGS_LIST))
    await client.get_channel(870028201924108310).send("Type $help for a list of commands")
...
client.run('ODcwMDM3Njk1MzMyNzU3NTE1.YQG7vw.5vpBTFkhZwry9TLWPcc-lwgAAaU')